  ...
  return (
    <section className="py-24 bg-slate-900">
      ...
      <p className="text-center text-slate-400 mt-4">
        AI-powered tools to accelerate your career.
      </p>

      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto mt-16 px-8">
        {features.map((item, index) => (
          <Link key={index} to={item.link}>
            <div className="bg-slate-800 rounded-2xl p-8 hover:scale-105 hover:bg-slate-700 transition duration-300 cursor-pointer h-full">
